            ...
            rows.append(
                {
                    ...
                    "pre_route_reason": decision.evidence.get("pre_route_reason", ""),
                    "ood_score": decision.evidence.get("ood_score", 0.0),
                    "uncertainty_score": decision.evidence.get("uncertainty_score", 0.0),
                    "ood_high": decision.evidence.get("ood_high", 0.0),
        ...
        rows.append(
            {
                ...
                "pre_route_lane": first["pre_route_lane"],
                "pre_route_reason": first["pre_route_reason"],
                "ood_score": first["ood_score"],
                "uncertainty_score": first["uncertainty_score"],
                "ood_high": first["ood_high"],
