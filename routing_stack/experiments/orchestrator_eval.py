...
def evaluate_public(
    ...
    for example in examples:
        normalized = normalize_input({"input_type": "text", "prompt": example["prompt"]})
        for tier in tiers:
            request = RouteRequest(prompt=normalized.text, tier=tier, input_features=normalized.router_features)
